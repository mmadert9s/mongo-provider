# ====================================================================================
# Setup Project
PROJECT_NAME := provider-mongoprovider
...
XPKGS = provider-mongoprovider
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-mongoprovider: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider MongoProvider CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider MongoProvider controllers
...
# This target prepares repo for your provider by replacing all "mongoprovider"
